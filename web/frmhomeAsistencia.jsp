...
<!--        <div id="sidebar" align="right">
    ...
    <!-- start footer -->
    <div id="footer">
        <p id="legal">( c ) 2016. All Rights Reserved. <a href="http://www.lordbrain.edu.pe/">Lord Brain</a> designed by <a href="https://www.facebook.com/apiservi">APISERVI SAC</a>.</p>
    </div>
    <!-- end footer -->      
</body>
</html>
