    ...
    <body>
        ...
        <div id="page">
            ...
            <div id="content" style="width: 800px;margin-left: auto;margin-right: auto;">
                <div class="post">
                    <form class="">
                        <table id="tblAsistencia" style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 567px;">
                                    ...
                                    <button id="btnBuscarAsistenciaProfesorConsolidado" type="submit" style="height: 30px;width: 125px;margin-right: 2px;">Buscar</button>
                                    <button id="btnExportarBuscarAsistenciaProfesorConsolidado" type="submit" style="height: 30px;width: 125px;margin-right: 2px;">Exportar Excel</button> 
                                </td> 
                            <tr>
