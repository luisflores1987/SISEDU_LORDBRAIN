                        ...
                        <table id="tblAsistencia" style="width: 100%;">
                            <tr>
                                ...
                                <td style="width: 567px;">
                                    ...
                                    <button id="btnBuscarAsistenciaProfesor" type="submit" style="height: 30px;width: 120px;margin-right: 2px;">Buscar</button>
                                    <button id="btnExportarBuscarAsistenciaProfesor" type="submit" style="height: 30px;width: 115px;margin-right: 2px;">Exportar Excel</button> 
                                </td> 
                            </tr>                        
                            <tr>
