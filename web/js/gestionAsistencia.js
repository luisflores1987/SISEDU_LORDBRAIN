...
function getRandValueAlumno() {
    $.ajax({
        type: "GET",
        url: "obtenerNuevosRegistros",
        data: {
            action: "obtenerAsistenciaAlumno"
        }
    })
            .done(function(data, nativeStatusText, responses) {
                if (data != "0") {
                    ...
                    $('#asistenciaProfesor').show(500, function() {
                        setAsistenciaAlumno();    
                        fnMostrarDatosAlumnoAsistencia();
                    })
...
function setAsistenciaAlumno() {

    $.ajax({
        type: "GET",
        url: "obtenerNuevosRegistros",
        data: {
            action: "colocarAsistenciaAlumno",
            sCodigo: $('#txtCodigo').val()
        }
    })
...
function fnMostrarDatosAlumnoAsistencia() {
    $.ajax({
        type: "Get",
        url: "obtenerNuevosRegistros",
        data: {
            action: "obtenerDatosAlumnoAsistencia",
            sCodigo: $('#txtCodigo').val()
        }
    })
...
function fnEventoBotonAlumno() {
    $('#btnIngresarMarcado').on('click', function() {
        ...
        $.ajax({
            url: "obtenerNuevosRegistros",
            data: {
                action: "colocarAsistenciaManualAlumno",
                sCodigo: $('#txtCodigo').val()
            }
        })
                .done(function(data) {
...
function fnEventoBotonAlumnoEnter() {
