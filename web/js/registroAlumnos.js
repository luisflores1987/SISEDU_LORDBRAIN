...
// se abre un dialog.
    ...
    /*
     Procedimiento para busqueda de alumno    
     Inicio
     */
    ...
    // limpiar tabla
    fnCerrarVentanaAlumno();

    fnAbrirVentanaAlumno();
            ...
            .done(function(data, status, jqXhr) {
                ...
                if (data == '') {
                    ...
                    for (var i = 0; i < arregloAlumnos.length - 1; i++) {
                        ...
                        if (sCodigoColor == 0) {
                            $('#tblAlumnos').append('<tr data-dismiss="modal" class="danger">\n\
                                                                    ...
                                                                    <td><label>' + sAnioAcademico + '</label></td>\n\
                                                            </tr>');
                        } else {
                            $('#tblAlumnos').append('<tr data-dismiss="modal">\n\
                                                                    <td><label>' + numeroDocumento + '</label></td>\n\
                                                                    <td><label>' + apellidoPaterno + '</label></td>\n\
                                                                    <td><label>' + apellidoMaterno + '</label></td>\n\
                                                                    <td><label>' + nombres + '</label></td>\n\
...
function fnCerrarVentanaAlumno() {
