    ...
    .done(function(data){
        ...
        if(data == null){
            ...
            for(var i=0;i<arregloGrado.length - 1;i++)
            {
                ...
                $('#ulGradoProfesor').append('<li style="font-size: xx-large;"><input type="radio" name="grado" value="' + nidGrado + '" style="margin-left: 10px;margin-right:10px;width:20px;height: 20px;" /><label id=lbl' + nidGrado +'>'+ sDescripcion +'</label></li>')
            }
            clickRadioButton();
        }
        function  fnLimpiar(){
