...
public class RegistroPagosDAO {
    ...
    List<List<Object>> listaBoletaExportar = new ArrayList<List<Object>>();
    ...
    public List<Boleta> consultaDatosPagos(boolean bDni, boolean bApenom, boolean bNivel, boolean bBoleta, boolean bFecha, String sDni, String sNombres, int nNivel, String sBoleta, String sFechaINICIAL, String sFechaFINAL) {
        Connection con = Conexion.conectar();
        listaBoleta = new ArrayList<Boleta>();
        try {
    ...
    public List<List<Object>> consultaDatosPagosReporte(
            boolean bDni, boolean bApenom, boolean bNivel,
            boolean bBoleta, boolean bFecha, String sDni,
            String sNombres, int nNivel, String sBoleta,
            String sFechaINICIAL, String sFechaFINAL
    ) {
        Connection con = Conexion.conectar();
        listaBoletaExportar.clear();
        
        try {
            CallableStatement cs = con.prepareCall("{call [dbo].[s_filtroConsultaPagosAlumnoExportar](?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)}");
