...
public class Conexion {
    ...
    //private static String dbName = "siseduDesarrolloNotasWallon";
    private static String dbName = "siseduDesarrolloNotasLordBrain";

    //private static String dbName = "siseduDesarrolloBoletaLordBrain";            
    //private static String dbName = "SiseduProduccion";
