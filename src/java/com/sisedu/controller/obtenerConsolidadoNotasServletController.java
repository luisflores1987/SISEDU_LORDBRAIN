...
//            }
    ...
    public HSSFCell creaCelda(HSSFRow row, HSSFCell cell, HSSFCellStyle cellStyle, 
                              int columnIndex, Object valor, int contador,  /// columnIndex ---> el numero de la columna
                              HSSFCellStyle cellStyleCabecera, HSSFCellStyle cellStyleCabecera1) {
