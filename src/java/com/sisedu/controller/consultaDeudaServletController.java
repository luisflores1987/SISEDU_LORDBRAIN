...
public class consultaDeudaServletController extends HttpServlet {
    ...
    private void consultaAlumnoDeuda(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String sNivel = request.getParameter("cboNivel")==null?"0":request.getParameter("cboNivel");
        String sGrado = request.getParameter("cboGrado")==null?"0":request.getParameter("cboGrado");

        boolean bNivel = Integer.valueOf(sNivel)>0; 
        boolean bGrado = Integer.valueOf(sGrado)>0;
